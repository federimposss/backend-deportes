        ...
        try:
            ...
            for marco in marcos:
                try:
                    ...
                    # Buscamos contenedores que representen un bloque de partido individual
                    bloques = soup.find_all(["div", "tr", "li", "section", "article"])
                    
                    for bloque in bloques:
                        texto_bloque = bloque.get_text(separator=" ", strip=True)
                        
                        # Cada partido individual tiene obligatoriamente una hora (ej. 19:00) y un "vs" o guion de enfrentamiento
                        ...
                        if tiene_hora and tiene_vs:
                            ...
                            # Limpiamos el título de basuras de calidad o textos sueltos
